...
function ConfigureRoute(mapPoint) {
	...
	if (pollName != ''){
		...
		var queryTask = new esri.tasks.QueryTask('https://maps.raleighnc.gov/ArcGIS/rest/services/Parks/ParkLocator/MapServer/1');	
...
function FindClosestFacility(from, toGraphics){
	...
	var closestFacilityTask = new esri.tasks.ClosestFacilityTask("https://maps.raleighnc.gov/ArcGIS/rest/services/Networks/WakeNetwork/NAServer/Closest%20Facility");
